...
USERS = [
    ...
    },
    {
        ...
        "password": "googlerramelams!",
        "image": "me.jpg",
    },
    {
        "username": "Nawin M S",
        "email": "nawinmutharasu2005@gmail.com",
        "password": "googlernawinms",
        "image": "anna.png",
    },
    {
        "username": "Sudha M ",
...
def clear_existing_data():
    ...
    db.execute(delete(models.Posts))
    db.execute(delete(models.Users))
    db.commit()
...
def update_post_dates():
    ...
    posts = db.execute(
        select(models.Posts).order_by(models.Posts.id)
    ).scalars().all()
    ...
    db.execute(
        update(models.Posts)
        .where(models.Posts.id == posts[0].id)
